...
$id = $arr['id'];
$sql = "SELECT * from anime1 where user_id='$id' and status='COMPLETED'";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    <td><a href=\"http://localhost/anime/code/delete_anime_completed.php?did=" . $row['id'] . "\"><button type='button'><span></span>Delete</button></a></td></tr>
";
}
