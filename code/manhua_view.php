...
$id = $arr['id'];
$sql = "SELECT * from manhua where user_id='$id'";
$result = mysqli_query($conn, $sql);
echo "<table><thead><tr><th>Manhua</th><th>Chapter</th><th>Status</th><th>Edit</th><th>Delete</th></tr></thead>";
while ($row = mysqli_fetch_array($result)) {
    ...
    <td><button type='button'><span></span><a href=\"http://localhost/anime/code/delete_manhua.php?did=" . $row['id'] . "\">Delete</a></button></td></tr>
";
}
