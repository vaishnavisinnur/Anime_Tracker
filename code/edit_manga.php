            ...
            body
{
    ...
    <body>
        ...
        <a href="manga_page.html"><img src="..images/27.png" height="80px" width="100px" title="MANGA PAGE"></a>
            <h1 class="dem">MANGA</h1>
...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE `manga` SET `id`='$id', `name` = '$name', `chapter` = '$chapter', `status` = '$status' WHERE `manga`.`id` = '$id'";
    if (mysqli_query($conn, $query)) {
        header('location:manga_page.html');
    } else {
        echo " $query. "
        . mysqli_error($conn);
    }
