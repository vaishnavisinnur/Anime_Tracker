        ...
        body
{
    width: 100%;
    height: 100vh;
    background-image: linear-gradient(rgba(0,0,0,0.75),rgba(0,0,0,0.75)),url(.code/./images/12.jpg);
...
$id = $arr['id'];
$sql = "SELECT * from manga where user_id='$id' and status='READING'";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    <td><button type='button'><span></span><a href=\"http://localhost/anime/code/delete_manga_reading.php?did=" . $row['id'] . "\">Delete</a></button></td></tr>
";
}
